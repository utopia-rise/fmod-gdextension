...
class TestBank:
	...
	func test_assert_bank_bus_count():
		...
		assert_eq(Fmod.get_bank_bus_count("./assets/Banks/Music.bank"), desiredValue, "Music bank should have " + str(desiredValue) + " buses")
		desiredValue = 12
		assert_eq(Fmod.get_bank_bus_count("./assets/Banks/Master Bank.bank"), desiredValue, "Master bank should have " + str(desiredValue) + " buses")
		desiredValue = 0
		assert_eq(Fmod.get_bank_bus_count("./assets/Banks/Vehicles.bank"), desiredValue, "Vehicles bank should have " + str(desiredValue) + " buses")
	
	func test_assert_bank_event_count():
		var desiredValue: int = 4
		assert_eq(Fmod.get_bank_event_count("./assets/Banks/Music.bank"), desiredValue, "Music bank should have " + str(desiredValue) + " events")
		desiredValue = 5
		assert_eq(Fmod.get_bank_event_count("./assets/Banks/Master Bank.bank"), desiredValue, "Master bank should have " + str(desiredValue) + " events")
		desiredValue = 2
		assert_eq(Fmod.get_bank_event_count("./assets/Banks/Vehicles.bank"), desiredValue, "Vehicles bank should have " + str(desiredValue) + " events")
	
	func test_assert_bank_string_count():
		var desiredValue: int = 0
		assert_eq(Fmod.get_bank_string_count("./assets/Banks/Music.bank"), desiredValue, "Music bank should have " + str(desiredValue) + " strings")
		assert_eq(Fmod.get_bank_string_count("./assets/Banks/Master Bank.bank"), desiredValue, "Master bank should have " + str(desiredValue) + " strings")
		assert_eq(Fmod.get_bank_string_count("./assets/Banks/Vehicles.bank"), desiredValue, "Vehicles bank should have " + str(desiredValue) + " strings")
	
	func test_assert_bank_vca_count():
		var desiredValue: int = 0
		assert_eq(Fmod.get_bank_VCA_count("./assets/Banks/Music.bank"), desiredValue, "Music bank should have " + str(desiredValue) + " VCAs")
		desiredValue = 3
