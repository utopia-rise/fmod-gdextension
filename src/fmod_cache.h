...
namespace godot {
    ...
    class FmodCache {
        ...
        HashMap<String, uint32_t> plugin_handles;
...
#ifndef IOS_ENABLED
        void add_plugin(const String& p_plugin_path, uint32_t p_priority = 0);
        bool has_plugin(const String& p_plugin_path) const;
        void remove_plugin(const String& p_plugin_path);
#endif
